[_tb_system_call storage=system/_copy_of_cat_ura_7.ks]
...
#
ねこは俺の半歩前を歩く。[p]
その姿は人ではないのに、どこか俺のよく知っている一人の幼馴染を過らせた。[p]
互いに何も言わない。[p]
でも……。[p]
[_tb_end_text]
...
[glink  color="black"  storage="copy_of_cat_ura_7.ks"  size="20"  x="-12"  y="276"  width=""  height=""  text="おまじないのせい、か"  _clickable_img=""  target="*おまじないのせい、か"  ]
[glink  color="black"  storage="copy_of_cat_ura_7.ks"  size="20"  x="-8"  y="334"  width=""  height=""  text="俺のせい、か"  _clickable_img=""  target="*俺のせい、か"  ]
[s  ]
*おまじないのせい、か
...
#
ここからではねこの顔は見えなかった。[p]
あんなこと。像のぼやけたこの言い方は、ゆうこ の後ろめたさの象徴なのかもしれない。[p]
俺にはその正体は分からないけど、[p]
その答えがきっとこの先にある。[p]
[_tb_end_text]

[jump  storage="copy_of_cat_ura_7.ks"  target="*common６"  ]
*俺のせい、か
...
[tb_start_text mode=1 ]
#
そういえば、昨日隕石を追って探索に来たのはここらへんだったっけ。[p]
視線を横に反らし、崖下から景色を覘く。[p]
すると、学校の校舎と体育館の低い屋根が東日に照らされているのが見えた。[p]
校舎を見下ろしているのだから、だいぶ高いところまで来たみたいだ。[p]
結局、昨日の場所がどの辺だったか、ということは分からなかった。[p]
たった昨日の出来事なのに、それすら分からない。[p]
[_tb_end_text]
...
[jump  storage="copy_of_cat_ura_8.ks"  target=""  ]
