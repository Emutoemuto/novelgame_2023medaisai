[_tb_system_call storage=system/_copy_of_cat_omote_3.ks]
...
ベツレヘム占いの下準備。[r]オオアマナ、[r]通称ベツレヘムの星っていうお花を使う占い。[p]
6月に咲くオオアマナをモミの木の天辺に、[r]クリスマスツリーのお星さまみたいに飾るんだって。[p]
そして、大切なものを代償にしてお花にお願いをするとね、[r]なんでも叶うらしいの。[p]
...
[playse  volume="60"  time="1000"  buf="0"  storage="autumn_insects1_(1).mp3"  ]
[tb_start_text mode=1 ]
#
...
[glink  color="black"  storage="copy_of_cat_omote_3.ks"  size="20"  x="-8"  y="254"  width=""  height=""  text="存在しない記憶……？"  _clickable_img=""  target="*存在しない記憶……？"  ]
[glink  color="black"  storage="copy_of_cat_omote_3.ks"  size="20"  x="-8"  y="307"  width=""  height=""  text="日記は偽物だろ"  _clickable_img=""  target="*日記は偽物だろ"  ]
[glink  color="black"  storage="copy_of_cat_omote_3.ks"  size="20"  x="-9"  y="363"  width=""  height=""  text="まるでファンタジーだな"  _clickable_img=""  target="*まるでファンタジーだな"  ]
[s  ]
*存在しない記憶……？
...
[jump  storage="copy_of_cat_omote_3.ks"  target="*common　表３"  ]
*日記は偽物だろ
...
[jump  storage="copy_of_cat_omote_3.ks"  target="*common　表４"  ]
*common　表４
...
[jump  storage="copy_of_cat_omote_4.ks"  target=""  ]
